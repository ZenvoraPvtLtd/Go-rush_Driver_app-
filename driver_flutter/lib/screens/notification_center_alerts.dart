...
class _NotificationCenterAlertsScreenState extends State<NotificationCenterAlertsScreen> {
  ...
  void _initNotifications() {
    ...
    _notifications = [
      _NotificationItemModel(
        ...
        title: available != null ? 'New Ride Request Available (${available.rideId})' : 'New Ride Request Available',
      ...
      _NotificationItemModel(
        ...
        title: lastComp != null ? 'Trip Completed - ₹${lastComp.totalFare.toStringAsFixed(0)} added' : 'Trip Completed - ₹320 added',
      ...
      _NotificationItemModel(
        ...
        message: 'Congratulations! You completed 15 trips this week. ₹1,000 bonus unlocked!',
        time: '2h ago',
        isUnread: false,
        category: 'alerts',
      ...
      _NotificationItemModel(
        ...
        message: 'Passenger Rahul Sharma rated your ride 5.0 with great driving compliment!',
        time: '1d ago',
        isUnread: false,
        category: 'alerts',
  ...
  List<_NotificationItemModel> get _filteredNotifications {
    switch (_selectedCategory) {
      ...
      case 2: // Trips
        return _notifications.where((n) => n.category == 'trips' || n.id == 'notif_2').toList();
      case 3: // Alerts
        return _notifications.where((n) => n.category == 'alerts' || n.id == 'notif_1').toList();
      case 0:
      default:
              ...
              child: filteredList.isEmpty
                  ? Center(
                      child: Column(
                        ...
                        children: const [
                          Icon(Icons.notifications_off_outlined, size: 48, color: QuickServeColors.textMuted),
                          SizedBox(height: 12),
                          Text(
                            'No notifications in this category',
                            style: TextStyle(color: QuickServeColors.textSecondary, fontSize: 14),
                          ),
                        ],
                      ),
                    )
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? QuickServeColors.primaryBlue : const Color(0xFFF1F5F9),
