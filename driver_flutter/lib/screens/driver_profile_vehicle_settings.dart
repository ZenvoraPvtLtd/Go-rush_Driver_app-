...
class DriverProfileVehicleSettingsScreen extends StatefulWidget {
  ...
  @override
  State<DriverProfileVehicleSettingsScreen> createState() => _DriverProfileVehicleSettingsScreenState();
}

class _DriverProfileVehicleSettingsScreenState extends State<DriverProfileVehicleSettingsScreen> {
  ...
  void initState() {
    super.initState();
    _liveProfile = TokenStorageService.instance.driverProfile ?? DriverBackendService.instance.driverProfile;
    ...
    if (TokenStorageService.instance.hasToken()) {
      try {
        ...
        if (res.isSuccess && res.driver != null && mounted) {
          setState(() {
            _liveProfile = res.driver;
          });
          await TokenStorageService.instance.setDriverProfile(res.driver!);
        }
      } catch (_) {}
    }
  }
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Container(
                            ...
                            child: const Icon(Icons.notifications_active_outlined, color: QuickServeColors.primaryOrange, size: 22),
                          ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  ...
                                  style: const TextStyle(fontSize: 17, fontWeight: FontWeight.bold, color: QuickServeColors.textDark),
                                ),
                          ...
                          child: Column(
                            ...
                            children: [
                              _buildToggleTile(
                                ...
                                subtitle: tr('Loud chime and popup for new incoming trip requests'),
                                value: _rideAlerts,
                                onChanged: (val) {
                              ...
                              _buildToggleTile(
                                ...
                                subtitle: tr('Notifications when nearby zones enter 1.5x - 2.5x surge'),
                                value: _surgeAlerts,
                                onChanged: (val) {
                              ...
                              _buildToggleTile(
                                ...
                                subtitle: tr('Instant alerts when customer pays or daily payout deposits'),
                              ...
                              _buildToggleTile(
                                ...
                                subtitle: tr('Critical safety bulletins, SOS checks & regulatory notices'),
                                value: _safetyAlerts,
                                onChanged: (val) {
                              ...
                              _buildToggleTile(
                                ...
                                subtitle: tr('Play incoming ride audio at maximum volume even when muted'),
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ...
                          AppToast.success(context, tr('Notification preferences saved successfully.'));
                        },
                        ...
                        child: Text(tr('Save Preferences'), style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                      ),
                      const SizedBox(height: 6),
                    ],
                  ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.language, color: QuickServeColors.primaryOrange, size: 22),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: Column(
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        separatorBuilder: (c, i) => const Divider(height: 1, color: QuickServeColors.borderLight),
                        itemBuilder: (c, idx) {
                          final lang = languages[idx];
                          final currentCode = AppLanguageService.instance.currentLanguageCode;
                          ...
                          return ListTile(
                            ...
                            title: Text(
                              ...
                              style: TextStyle(
                                ...
                                color: isSelected ? QuickServeColors.primaryOrange : QuickServeColors.textDark,
                              ),
                            ),
                            subtitle: Text(
                              lang['native']!,
                            ...
                            trailing: isSelected
                                ? const Icon(Icons.check_circle, color: QuickServeColors.primaryOrange, size: 22)
                                : const Icon(Icons.radio_button_unchecked, color: QuickServeColors.textMuted, size: 20),
                            onTap: () {
                              AppLanguageService.instance.setLanguage(lang['code']!);
                              Navigator.of(bottomSheetContext).pop();
                              if (mounted) setState(() {});
                              AppToast.success(
                                context,
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Icon(Icons.privacy_tip_outlined, color: QuickServeColors.primaryOrange, size: 22),
                            ),
                            const SizedBox(width: 12),
                            Expanded(
                              child: Column(
                            ...
                            child: Column(
                              children: [
                                _buildToggleTile(
                                  ...
                                  subtitle: tr('Require fingerprint or face scan when opening driver app'),
                                ...
                                _buildToggleTile(
                                  ...
                                  subtitle: tr('Always active while online for live customer GPS tracking'),
                                  value: _backgroundLocation,
                                  onChanged: (val) {
                                    setSheetState(() => _backgroundLocation = val);
                                    setState(() => _backgroundLocation = val);
                                  },
                                ),
                                _buildToggleTile(
                                  title: tr('2-Factor Payout Verification'),
                                  subtitle: tr('Send SMS OTP before transferring money to bank account'),
                                ...
                                _buildToggleTile(
                                  ...
                                  subtitle: tr('Anonymize real phone number when calling passengers'),
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      const Icon(Icons.verified_user_outlined, color: QuickServeColors.statusGreen, size: 20),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              ...
                                              style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: QuickServeColors.textDark),
                                            ),
                                            const SizedBox(height: 2),
                                            Text(
                                              tr('Location, Camera, Microphone and Storage access verified'),
                                              style: const TextStyle(fontSize: 11, color: QuickServeColors.textSecondary),
                                            ),
                                          ],
                                        ),
                                      ),
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            await TokenStorageService.instance.savePrivacySettings(settings);
                            try {
                            ...
                            if (context.mounted) {
                              AppToast.success(context, tr('Privacy and security settings updated.'));
                            }
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: QuickServeColors.primaryOrange,
                          ...
                          child: Text(tr('Save Security Settings'), style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                        ),
                        const SizedBox(height: 6),
                      ],
                    ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  title,
                  style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: QuickServeColors.textDark),
                ),
                const SizedBox(height: 2),
                Text(
                  subtitle,
  ...
  Widget build(BuildContext context) {
    ...
    final driverName = (rawName != null && rawName.isNotEmpty) ? rawName : 'Driver Partner';
    final driverPhone = pickField('phone') ?? '';
    final driverEmail = pickField('email') ?? '';
    final vehiclePlate = pickField('vehicleId') ?? pickField('vehicleNumber') ?? '';
                            ...
                            child: Column(
                              children: [
                                ...
                                Row(
                                  ...
                                  children: const [
                                    Icon(Icons.star, color: Color(0xFFFBBF24), size: 15),
                                    Icon(Icons.star, color: Color(0xFFFBBF24), size: 15),
                                    Icon(Icons.star, color: Color(0xFFFBBF24), size: 15),
                                    Icon(Icons.star, color: Color(0xFFFBBF24), size: 15),
                                    Icon(Icons.star_half, color: Color(0xFFFBBF24), size: 15),
                                    SizedBox(width: 6),
                                    Text(
                                      '4.9 rating',
                                      style: TextStyle(
                                ...
                                const SizedBox(height: 2),
                                Text(
                                  driverEmail.isNotEmpty && driverPhone.isNotEmpty
                                ...
                                if (licenseNumber.isNotEmpty) ...[
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(color: QuickServeColors.borderLight, width: 0.8),
                                    ),
                                    child: Text(
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: ElevatedButton.icon(
                                      ...
                                      onPressed: () {
                                        AppToast.success(context, tr('Status: Online & Ready for Rides!'));
                                      },
                                    ),
                                  ),
                                ),
                    ...
                    _buildSettingsGroup([
                      ...
                      _buildSettingItem(
                        ...
                        subtitle: licenseNumber.isNotEmpty
                            ...
                            : tr('Driving License, RC, Insurance'),
                        badge: tr('Verified'),
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          onTap: widget.onLogoutTap ?? () {
                            AppToast.show(context, tr('Session logged out.'));
                          },
                        ),
                      ),
                    ),
...
class _ChangePasswordPinModal extends StatefulWidget {
  ...
  @override
  State<_ChangePasswordPinModal> createState() => _ChangePasswordPinModalState();
}
...
class _ChangePasswordPinModalState extends State<_ChangePasswordPinModal> {
  ...
  Future<void> _handleSubmit() async {
    ...
    final curPass = _currentPasswordCtrl.text.trim();
    ...
    if (newPass.length < 4) {
      AppToast.error(context, tr('New password/PIN must be at least 4 characters long'));
      return;
    }
    ...
    try {
      ...
      if (result.success) {
        ...
        AppToast.error(
          context,
          result.message.isNotEmpty ? result.message : tr('Unable to change password. Please try again.'),
        );
      }
    } catch (_) {
      if (!mounted) return;
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.lock_reset, color: QuickServeColors.primaryOrange, size: 22),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: QuickServeColors.textDark),
                            ),
                            const SizedBox(height: 2),
                            Text(
                  ...
                  ElevatedButton(
                    ...
                    child: _isSubmitting
                        ...
                        : Text(tr('Update Password'), style: const TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
                  ),
                  const SizedBox(height: 6),
                ],
              ),
