...
class RideModel {
  ...
  factory RideModel.fromJson(Map<String, dynamic> json) {
    ...
    return RideModel(
      ...
      passengerAvatar: (passenger['avatar'] ?? 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150').toString(),
      ...
      destinationAddress: (destination['address'] ?? 'Connaught Place, New Delhi').toString(),
  ...
  factory RideModel.defaultSample() {
    return const RideModel(
      ...
      passengerAvatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150',
